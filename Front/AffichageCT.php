...
<h1>Cinéma/Théatre ..</h1>

<br><br>
<?php
$db = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
$sql = "SELECT idevent, nomevent, image, description FROM evenements WHERE domaine = 'Cinéma/Théatre..' AND date >= :current_date ORDER BY date ASC";
