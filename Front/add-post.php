...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $stmt = $dbh->prepare("INSERT INTO posts (title, category, grabber, description, username, image1, userid, status)
                      VALUES (:title, :cat, :grabber, :description, :username, :image1, :userid, :status)");

        $stmt->bindParam(':title', $title, PDO::PARAM_STR);
        $stmt->bindParam(':cat', $cat, PDO::PARAM_STR);
        $stmt->bindParam(':grabber', $grabber, PDO::PARAM_STR);
                    ...
                    <form id="contactForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls">
                                ...
                                <input class="form-control" type="text" id="description" required placeholder="description"
                                       name="description">
