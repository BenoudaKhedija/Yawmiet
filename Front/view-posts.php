    ...
    <article>
        <div class="container">
            <div class="row">
                ...
                $s = 1;
                $sql = "SELECT posts.*, categories.catname FROM posts JOIN categories ON categories.id = posts.category WHERE posts.status = :s ORDER BY posts.creationdate DESC LIMIT $offset, $total_records_per_page";
