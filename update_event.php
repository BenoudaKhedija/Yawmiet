...
try {
  $sql = "UPDATE evenements SET nomevent=:nom, domaine=:domaine, date=:date, description=:description, nb_place=:nb_place, prix_billet=:prix_billet WHERE idevent=:idevent";
  $stmt = $conn->prepare($sql);
  $stmt->bindParam(':idevent', $idevent);
